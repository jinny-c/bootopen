...
public class GsonUtils {
    ...
    static {
        gson = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().enableComplexMapKeySerialization().serializeNulls()
                .disableHtmlEscaping().setDateFormat("yyyyMMddHHmmss").setVersion(1.00).setFieldNamingPolicy(FieldNamingPolicy.UPPER_CAMEL_CASE).create();
